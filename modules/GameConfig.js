...
export const GameConfig = {
  ...
  RENDERING: {
    ...
    // Ground object positioning
    GROUND_LEVEL_Y: 0.85,
    GROUND_OBJECT_MAX_SIZE_RATIO: 0.12,
    GROUND_OBJECT_HEIGHT_RATIO: 0.3,
    GROUND_GLOW_OPACITY: 0.5,
    GROUND_GLOW_SIZE_RATIO: 0.6,
    GROUND_GLOW_HEIGHT_RATIO: 0.18,
    GROUND_PROJECTION_WIDTH_RATIO: 0.4,
    GROUND_FOV_EXTENSION: 1.2,
    GROUND_VISIBILITY_DISTANCE: 1.0,

    // Mobile ground circle
    MOBILE_GROUND_Y_RATIO: 0.7,
    MOBILE_GROUND_DISTANCE_MULTIPLIER: 8,
